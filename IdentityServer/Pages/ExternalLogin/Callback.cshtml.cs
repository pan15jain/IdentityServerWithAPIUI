...
{
    private readonly UserManager<TrimarkUser> _userManager;
    private readonly SignInManager<TrimarkUser> _signInManager;
    ...
    public Callback(
        ...
        UserManager<TrimarkUser> userManager,
        SignInManager<TrimarkUser> signInManager)
    {
    ...
    private async Task<TrimarkUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        var sub = Guid.NewGuid().ToString();
            
        var user = new TrimarkUser
        {
            Id = sub,
